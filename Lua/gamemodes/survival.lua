...
function gm:Start()
    ...
    local loottable = {
        ...
        secarmcab = {
            ...
            {"husk_smg", 1, 1, 1},
            {"husk_smg", 0.75, 1, math.random(1, 2)},
            {"husk_smg", 0.35, 2, 1},
            {"husk_smgunique", 0.1, 1, 1},
            {"husk_smgmag", 0.55, 1, math.random(1, 2)},
            {"husk_smgmag", 0.85, 2, 1},
            {"husk_smgmag", 0.65, 1, 1},
            {"husk_smgmagexpanded", 0.15, 1, math.random(1, 2)},
            {"pistol", 1, 1, 2},
            {"pistol", 0.5, 1, 1},
            {"pistol", 0.5, 1, 1},
            ...
            {"12_shell", 0.85, 1, math.random(1, 4)},
            {"12_shell", 0.35, 2, 1 + math.random(1, 2)},
