...
language.Tips = {
    ...
    "Make sure you've read the in-game rules!",
    "As the administrator or a security officer of the azoe region, make sure you are caught up on the region's laws.",
}
...
language.Pointshop = {
    ...
    wiring = "Wiring",
    ores = "Ores",
    administrator2 = "Order Cargo (Azoe Region)",
    administrator1 = "Order Cargo (Institute)",
    security = "Security",
    ships = "Ships",
    materials = "Materials",
    medical = "Medical",
    ...
    idcardlocator_resultmedic = "%s - %s - %s meters away - %s - %s",
}
